    ...
    <div class="instructor-profile-right-part">
        <div class="instructor-quiz-list-page instructor-create-live-class-page">
            <div class="instructor-my-courses-title d-flex justify-content-between align-items-center">
                <h6>Create Program Session</h6>
            </div>

            <div class="row">
                <div class="col-12">
                    <form action="{{ route('admin.program-session.store', $course->uuid) }}" method="post">
                        @csrf
                        <div class="row mb-30">
                            <div class="col-md-12">
                        ...
                        <div class="row mb-30">
                            <div class="col-md-12">
                                ...
                                <input type="text" name="class_topic" class="form-control topic"
                                       placeholder="Enter your topic" required value="{{ old('class_topic') }}">
                        ...
                        <div class="row mb-30">
                            <div class="col-md-12">
                                ...
                                <input type="number" name="duration" class="form-control duration"
                                       placeholder="Type duration in minutes" required>
                            ...
                            <div class="col-md-12">
                                ...
                                <select name="session_type" id="session_type" class="form-select session_type"
                                    ...
                                    <option value="{{ PROGRAM_SESSION_TYPE_LIVE }}"
                                        {{old('session_type')==PROGRAM_SESSION_TYPE_LIVE ? 'selected' : '' }}>
                                        LIVE
                                    </option>
                                    <option value="{{ PROGRAM_SESSION_TYPE_ONSITE }}"
                                        {{old('session_type')==PROGRAM_SESSION_TYPE_ONSITE ? 'selected' : '' }}>
                                        ONSITE
                                    </option>
                                </select>
                        ...
                        <div class="row liveSession d-none">
                            <div class="row">
                        ...
                        <div class="row onSiteSession d-none">
                            <div class="row mb-30">
                                <div class="col-md-12">
                                    <label
                        ...
                        <div>
                            ...
                            <button type="submit"
                                    class="theme-btn theme-button1 default-hover-btn">{{ __('Create Meeting') }}</button>
                        </div>
                    </form>
