            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-8">
                    <div class="email-inbox__area bg-style">
                        ...
                        <form action="{{route('settings.banner-section.update',$banner->id)}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                            @csrf
                            <div class="input__group mb-25 row">
                                ...
                                <div class="col-lg-9">
                                    <select class="form-control multiple-select-input" name="banner_mini_words_title[]" id="banner_mini_words_title" multiple="multiple">
                                        @foreach($banner->banner_mini_words_title ?? [] as $item)
                            ...
                            <div class="input__group mb-25 row">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" name="banner_first_line_title" id="banner_first_line_title"
                                           value="{{ @$banner->banner_first_line_title }}" class="form-control" required>
                                </div>
                            </div>
                            <div class="input__group mb-25 row">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" name="banner_second_line_title" id="banner_second_line_title"
                                           value="{{ @$banner->banner_second_line_title }}" class="form-control" required>
                                </div>
                            </div>
                            <div class="input__group mb-25 row">
                                ...
                                <div class="col-lg-9">
                                    <select class="form-control multiple-select-input" name="banner_second_line_changeable_words[]" id="banner_second_line_changeable_words" multiple="multiple">
                                        @foreach($banner->banner_second_line_changeable_words ?? [] as $item)
                                            <option value="{{ @$item }}" selected>{{ @$item }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="input__group mb-25 row">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" name="banner_third_line_title" id="banner_third_line_title" value="{{ @$banner->banner_third_line_title }}" class="form-control" required>
                                </div>
                            </div>
                            <div class="input__group mb-25 row">
                                <label for="banner_subtitle" class="col-lg-3"> {{ __('Subtitle') }} <span class="text-danger">*</span></label>
                                <div class="col-lg-9">
                                    <input type="text" name="banner_subtitle" id="banner_subtitle" value="{{ @$banner->banner_subtitle }}" class="form-control" required>
                                </div>
                            </div>
                            <div class="input__group mb-25 row">
                                <label for="banner_button_name" class="col-lg-3">{{ __('Button Name') }} </label>
                                <div class="col-lg-9">
                                    <input type="text" name="banner_button_name" id="banner_button_name" value="{{ @$banner->banner_button_name }}"
                                           class="form-control" >
                                </div>
                            </div>
                            <div class="input__group mb-25 row">
                                <label for="banner_button_link" class="col-lg-3">{{ __('First Button Link') }} </label>
                                <div class="col-lg-9">
                                    <input type="text" name="banner_button_link" id="banner_button_link" value="{{ @$banner->banner_button_link }}"
                                           class="form-control" >
                                </div>
                            </div>
                                ...
                                <div class="col-lg-5">
                                    <div class="upload-img-box">
                                        @if( @$banner->banner_image)
                                            <img src="{{getImageFile(@$banner->banner_image_path)}}">
                                        @else
                                            <img src="" alt="img">
                                        @endif
