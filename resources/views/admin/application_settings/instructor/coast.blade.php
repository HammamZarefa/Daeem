                    ...
                    <div class="email-inbox__area bg-style">
                        ...
                        <form action="{{route('settings.general_setting.cms.update')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="form-group text-black row mb-3">
                                <label class="col-lg-3" for="become_instructor_coast">{{ __('Become Instructor Coast') }} <span class="text-danger">*</span></label>
                                <div class="col-lg-9">
                                    <input type="text" name="become_instructor_coast" value="{{get_option('become_instructor_coast')}}" class="form-control" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
