                                    ...
                                    @if($course->lessons->count() > 0)
                                        ...
                                        <div id="upload-course-video-2">
                                                                    ...
                                                                    <div id="collapse{{$key}}" class="accordion-collapse collapse {{$key == 0 ? 'show' : '' }} "
                                                                        ...
                                                                        <div class="accordion-body">
                                                                                    ...
                                                                                    <div class="d-flex">
                                                                                        <div class="flex-shrink-0">
                                                                                            <div
                                                                                                ...
                                                                                                <a href="{{route('admin.course.edit.lecture', [$course->uuid, $lesson->uuid, $lecture->uuid])}}"
                                                                                                   type="button"
                                                                                                ...
                                                                                                <a href="javascript:void(0);"
                                                                                                   data-url="{{route('admin.course.delete.lecture', [$course->uuid,  $lecture->uuid])}}"
                                                                                ...
                                                                                <div class="d-flex justify-content-between align-items-center">
                                                                                    ...
                                                                                    <div>
                                                                                        <button type="button" data-name="{{ $lesson->name }}"
                                                                                                data-route="{{ route('admin.course.lesson.update', [$course->uuid, $lesson->uuid]) }}"
                                                                                        ...
                                                                                        <form action="{{ route('admin.course.lesson.delete', [$lesson->uuid]) }}" method="post"
                                                                            ...
                                                                            <div class="mt-3 lecture-edit-upload-btn">
                                                                                <a href="{{route('admin.course.upload.lecture', [$course->uuid, $lesson->uuid])}}"
                                            ...
                                            <div class="add-more-section-wrap d-none">
                                                <form method="POST" action="{{route('admin.course.lesson.store', [$course->uuid])}}" class="row g-3 needs-validation" novalidate>
                                                    @csrf
                                                    <div class="row mb-30">
                                                        <div class="col-md-12">
