...
<div class="bg-page">
    ...
    <section class="course-single-details-area course-watch-page-area">
        <div class="container-fluid">
            ...
            <div class="row">
                <div
                    class="col-12 col-md-12 col-lg-12 col-xl-7 col-xxl-8">
