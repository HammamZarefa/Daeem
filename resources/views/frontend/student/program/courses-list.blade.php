                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-12">
                        <div class="page-banner-content text-center">
                            <h3 class="page-banner-heading color-heading pb-15">{{__('My Training Programmes')}}</h3>

                            <!-- Breadcrumb Start-->
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb justify-content-center">
                                    <li class="breadcrumb-item font-14"><a href="{{url('/')}}">{{__('Home')}}</a></li>
                                    <li class="breadcrumb-item font-14 active" aria-current="page">{{__('My Training Programmes')}}</li>
                                </ol>
                            </nav>
                            <!-- Breadcrumb End-->
                        </div>
...
<section class="wishlist-page-area my-courses-page">
    <div class="container">
        <div class="row">
            ...
            <div class="col-12">
                <div class="courses-filter-bar d-flex align-items-start justify-content-between">
                    <div class="filter-bar-left">
                        <a href="{{ route('programmes') }}" class="theme-btn theme-button1 theme-button3">{{__('Browse More Program')}}</a>
                    </div>
            ...
            @include('frontend.student.program.render-programmes-list')
            </div>
        </div>
    </div>
</section>
