                                    ...
                                    @forelse($carts as $cart)
                                        ...
                                        <tr class="removable-item">
                                            ...
                                            <td class="wishlist-remove font-15">
                                                ...
                                                <form action="{{ route('student.cartDelete', $cart->id) }}"
                                                      method="post"
                    ...
                    <div class="col-lg-3">
                        <div class="order-summary-box bg-white">
                            <form method="POST" action="{{route('student.goToCheckout')}}">
                                ...
                                <div
                                    class="cart-order-summary-item-box d-flex justify-content-between align-items-center">
...
{{--                                        @endif--}}
                                        ...
                                        @endif
                                        <input type="submit"
                                               class="theme-btn load-more-btn w-100 justify-content-center mt-3"
