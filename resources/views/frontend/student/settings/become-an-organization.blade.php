                    ...
                    <div class="row">
                        <div class="col-12 col-sm-12 col-md-12">
                            <div class="page-banner-content text-center">
                                <h3 class="page-banner-heading text-white pb-15">{{__('Become an Organization')}}</h3>

                                <!-- Breadcrumb Start-->
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb justify-content-center">
                                        <li class="breadcrumb-item font-14"><a href="{{ url('/') }}">{{__('Home')}}</a></li>
                                        <li class="breadcrumb-item font-14 active" aria-current="page">{{__('Become an Organization')}}</li>
                                    </ol>
                                </nav>
                                <!-- Breadcrumb End-->
                            </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="d-flex justify-content-sm-center become-instructor-call-to-action align-items-center mt-50">
                        <button class="theme-btn theme-button1 theme-button3 mr-30" data-bs-toggle="modal" data-bs-target="#becomeAnInstructor"> {{__('Become an Organization')}} <i data-feather="arrow-right"></i></button>
    ...
    <div class="modal fade becomeAnInstructorModal" id="becomeAnInstructor" tabindex="-1" aria-labelledby="becomeAnInstructorLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form method="POST" action="{{route('student.save-organization-info')}}" class="needs-validation" novalidate enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        ...
                        <div class="row mb-30">
                            <div class="col-md-12">
                                <label for="work_field"
                                       class="label-text-title color-heading font-medium font-16 mb-2">{{__('Work Field')}}</label>
                                <input type="text" name="work_field" class="form-control"
                                       id="professional_title" placeholder="{{__('Work Field')}}"
                                       value="{{ old('work_field') }}">
                            </div>
                            @if ($errors->has('work_field'))
                                <span class="text-danger"><i class="fas fa-exclamation-triangle"></i> {{ $errors->first('work_field') }}</span>
                            @endif
                        </div>
                        ...
                        <div class="row mb-30">
                            <div class="col-md-12">
                                <label class="label-text-title color-heading font-medium font-16 mb-2">{{__('Organization Name')}}</label>
                                <input type="text" name="organization_name" class="form-control" id="organization_name" placeholder="Write your Organization name" value="" required>
                            </div>
                            @if ($errors->has('organization_name'))
                                <span class="text-danger"><i class="fas fa-exclamation-triangle"></i> {{ $errors->first('organization_name') }}</span>
                            @endif
                        </div>

                        <div class="row mb-30">
                            <div class="col-md-12">
                                <label class="label-text-title color-heading font-medium font-16 mb-2">{{__('Organization Email')}}</label>
                                <input type="text" name="organization_email" class="form-control" id="organization_email" placeholder="Write your Organization Email" value="{{ @Auth::user()->email }}" required>
                            </div>
                            @if ($errors->has('organization_email'))
                                <span class="text-danger"><i class="fas fa-exclamation-triangle"></i> {{ $errors->first('organization_email') }}</span>
                            @endif
                        </div>
                        ...
                        <div class="row mb-30">
                            <div class="col-md-12">
                                <label class="label-text-title color-heading font-medium font-16 mb-2">{{__('Agent Email')}}</label>
                                <input type="text" name="agent_email" class="form-control" id="agent_email" placeholder="Write your Agent Email" value="" required>
                            </div>
                            @if ($errors->has('agent_email'))
                                <span class="text-danger"><i class="fas fa-exclamation-triangle"></i> {{ $errors->first('agent_email') }}</span>
                            @endif
                        </div>

                        <div class="row mb-30">
                            <div class="col-md-12">
                                <label class="label-text-title color-heading font-medium font-16 mb-2">{{__('Agent First Name')}}</label>
                                <input type="text" name="first_name" class="form-control" id="first_name" placeholder="Write your agent first name" value="{{ @Auth::user()->student->first_name }}" required>
                            </div>
                        ...
                        <div class="row mb-30">
                            <div class="col-md-12">
                                <label class="label-text-title color-heading font-medium font-16 mb-2">{{__('Agent Last Name')}}</label>
                                <input type="text" name="last_name" class="form-control" id="last_name" placeholder="Write your agent last name" value="{{ @Auth::user()->student->last_name }}" required>
                            </div>
