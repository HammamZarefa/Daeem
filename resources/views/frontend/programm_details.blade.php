...
<h3 class="page-banner-heading text-white pb-30">Bundle course - Web development special offer</h3>
<p class="instructor-name-certificate font-medium font-12 text-white">
<span class="text-decoration-underline">Benjamin Lucas</span>
| Author Level 1
</p>
</div>
</div>
...
<li class="nav-item" role="presentation">
<a class="nav-link" id="Courses-list-tab" data-bs-toggle="tab" href="#Courses-list" role="tab" aria-controls="Courses-list" aria-selected="false" tabindex="-1">Courses list (2)</a>
</li>
<li class="nav-item" role="presentation">
<a class="nav-link" id="Instructor-tab" data-bs-toggle="tab" href="#Instructor" role="tab" aria-controls="Instructor" aria-selected="false" tabindex="-1">Instructor</a>
</li>
</ul>
</div>
...
<p class="font-12 mb-2">Organization Owner</p>
...
<div class="meet-instructor-extra-info-item color-heading"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" class="iconify iconify--ph" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 256 256" data-icon="ph:monitor-light"><path fill="currentColor" d="M208 42H48a22 22 0 0 0-22 22v112a22 22 0 0 0 22 22h160a22 22 0 0 0 22-22V64a22 22 0 0 0-22-22Zm10 134a10 10 0 0 1-10 10H48a10 10 0 0 1-10-10V64a10 10 0 0 1 10-10h160a10 10 0 0 1 10 10Zm-52 48a6 6 0 0 1-6 6H96a6 6 0 0 1 0-12h64a6 6 0 0 1 6 6Z"></path></svg>3 Courses
</div>
</div>
</div>
</div>
