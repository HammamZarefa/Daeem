                ...
                <div class="course-single-details-left-content bg-white">
                    ...
                    <div class="course-tab-nav-wrap course-details-tab-nav-wrap d-flex justify-content-between">
                        <ul class="nav nav-tabs tab-nav-list border-0" id="myTab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" id="Instructor-tab" data-bs-toggle="tab" href="#coaches" role="tab" aria-controls="Review" aria-selected="false">{{ (count($course->course_instructors->where('status', STATUS_APPROVED)) > 1) ? __('coaches') : __('coach') }}</a>
                            </li>
                        </ul>
                    </div>
                    <!-- Tab panel nav list -->
                    ...
                    <div class="tab-content" id="myTabContent">
                        @include('frontend.program.partial.partial-overview-tab')
                        @include('frontend.program.partial.partial-curriculum-tab')
                        @include('frontend.program.partial.partial-discussion-tab')
                        @include('frontend.program.partial.partial-review-tab')
                        @include('frontend.program.partial.partial-instructor-tab')
                    </div>
                </div>
            </div>
                    ...
                    <div class="course-info-box bg-white">
                            ...
                            <ul class="pb-30">
                                <li class="d-flex justify-content-between">
                                    <div>
                                        ...
                                        <span>{{ __('Program Duration') }}</span>
                                    </div>
                                    <div>{{ @$course->SessionDuration }}</div>
                                </li>
                                <li class="d-flex justify-content-between">
                                    <div>
                                        <span class="iconify" data-icon="carbon:increase-level"></span>
                                        <span>{{ __('Program Level') }}</span>
                                    </div>
                        ...
                        @else
                            <button class="theme-btn theme-button1 theme-button3 w-100 mb-30 addToCart " data-course_id="{{ $course->id }}"
                                ...
                                <span class="msgInfoChange">{{ __('Enroll the Program') }} <i data-feather="arrow-right"></i></span>
                        ...
                        <div class="course-info-box-wishlist-btns d-flex mb-30">
                            ...
                            <button class="theme-btn para-color font-medium mx-2" title="Share this course" data-bs-toggle="modal" data-bs-target="#shareThisCourseModal"><span class="iconify me-2" data-icon="ci:share-outline"></span>{{ __('Share Program') }}</button>
                        </div>

                        <div class="course-includes-box mb-30">
                            <h6 class="pb-30">{{ __('This Program Includes') }}</h6>
                            <ul>
                                <li>
                                    <span class="iconify" data-icon="bi:camera-video"></span>
                                    <span>{{@$course->programSessions()->where('session_type',1)->count() }} {{ __('Live Session') }}</span>
                                </li>
                                <li>
                                    <span class="iconify" data-icon="bi:camera-video"></span>
                                    <span>{{@$course->programSessions()->where('session_type',2)->count() }} {{ __('Onsite Session') }}</span>
                                </li>
{{--                                <li>--}}
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title" id="shareThisCourseModalLabel">{{ __('Share This Program') }}</h6>
