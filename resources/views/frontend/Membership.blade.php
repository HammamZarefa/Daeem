                    ...
                    <div class="page-banner-content text-center" style="display: flex;
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb justify-content-center">
                                ...
                                <li class="breadcrumb-item font-14 active" aria-current="page">{{ __('Members') }}</li>
                            </ol>
                        </nav>
                                                </div>
        ...
        <div class="container">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item na-item" role="presentation">
                    <button class="nav-link na-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true">عضوية المنظمات 
</button>
                </li>
                <li class="nav-item na-item" role="presentation">
                    <button class="nav-link na-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">عضوية كوتش
</button>
                </li>
                <li class="nav-item na-item" role="presentation">
                    <button class="nav-link na-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact" type="button" role="tab" aria-controls="contact" aria-selected="false">عضوية مستفيد
</button>
                </li>
            </ul>
            <div class="tab-content section-t-space" id="myTabContent">
                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab" style="padding-top: 200px;">
                    <!-- *************** item **************** -->
...
<a class="nav-link active" id="Overview-tab" data-bs-toggle="tab" href="#Overview" role="tab" aria-controls="Overview" aria-selected="true">مميزاتها عضوية المنظمات :</a>
</li>
</ul>
</div>
...
<p>
    <ul>
        ...
        <li>
        3.	تقديم إثراءات لمنسوبي المؤسسة من انتاج المنصة التربوي والتعليمي 
        </li>
        <li>
        ...
        <li>
        6.	تقديم خصم على البرامج النوعية للناشئة المنتسبين للمدرسة وفق منهجيه الكوتشينج
        </li>
        <li>
        7.	تقديم ثلاث جلسات مجانية في الكوتشينج القيادي لمدير المدرسة
        </li>
        <li>
...
<img src="https://lmszai.zainikthemes.com/uploads/bundle/1662703371-UulOac2DpP.jpg" alt="Bundle Image" class="img-fluid">
</div>
</div>
...
<div>
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" class="iconify iconify--carbon" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 32 32" data-icon="carbon:increase-level"><path fill="currentColor" d="m23 4l-5 3.75v6.5L15 12l-5 3.75v6.5L7 20l-5 3.75V30h2v-5.25l3-2.25l3 2.25V30h2V16.75l3-2.25l3 2.25V30h2V8.75l3-2.25l3 2.25V30h2V7.75L23 4z"></path></svg>
...
<button class="theme-btn theme-button1 theme-button3 w-100 mb-30 addToCart" data-bundle_id="4" data-route="https://lmszai.zainikthemes.com/student/add-to-cart">
تسجيل العضوية<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-right"><line x1="5" y1="12" x2="19" y2="12"></line><polyline points="12 5 19 12 12 19"></polyline></svg>
</button>
</div>
</div>
</div>
